...
namespace SolveIT_BackEnd.Migrations
{
    ...
    [Migration("20241011015132_removed-circular")]
            ...
            modelBuilder.Entity("SolveIT_BackEnd.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Country = 0,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2024, 10, 11, 1, 51, 32, 112, DateTimeKind.Utc).AddTicks(3861),
                            IsActive = false,
                            Name = "IT"
                        },
                        new
                        {
                            ...
                            Country = 0,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2024, 10, 11, 1, 51, 32, 112, DateTimeKind.Utc).AddTicks(3863),
                            IsActive = false,
                            Name = "HR"
                        });
                });
            ...
            modelBuilder.Entity("SolveIT_BackEnd.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedById = 1,
                            CreatedOn = new DateTime(2024, 10, 11, 1, 51, 32, 112, DateTimeKind.Utc).AddTicks(3878),
                            DepartmentId = 1,
            ...
            modelBuilder.Entity("SolveIT_BackEnd.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2024, 10, 11, 1, 51, 32, 112, DateTimeKind.Utc).AddTicks(3790),
                            Description = "Whatevs",
                            IsActive = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2024, 10, 11, 1, 51, 32, 112, DateTimeKind.Utc).AddTicks(3792),
                            Description = "Whatevs",
                            IsActive = false,
                            Name = "User"
                        });
